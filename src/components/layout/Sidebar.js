          ...
          >
            <img
              ...
              src={isSuperAdmin
                ? superLogo
                : (companyLogo
                  ? (companyLogo.startsWith('data:') || companyLogo.startsWith('http') ? companyLogo : `${SERVER_URL}/${companyLogo.replace(/\\/g, '/').startsWith('/') ? companyLogo.replace(/\\/g, '/').substring(1) : companyLogo.replace(/\\/g, '/')}`)
                  : superLogo)
              }
